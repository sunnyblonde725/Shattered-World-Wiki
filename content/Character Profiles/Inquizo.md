...
**Player:** Charlie | **Race:** Kobold | **Class:** Rogue (Thief subclass) | **From:** SKRP

---

### Who He Is

Inquizo is chaos incarnate. He presses every button, claims every hat, releases spiders at strategic moments, and can read but chooses not to — playing dumb about it with zero shame. He has the highest confirmed Persuasion roll in the campaign (24), used to argue that his jar of spiders was legally part of his body. He once turned the clock hands counter-clockwise and accidentally reversed time. He threw a glowing blue clock off a bridge and turned the sky red. These are not unrelated events.

He carries a black orb with an unidentified entity inside. He stole the core of George's broken hammer and still hasn't given it back. He saw a smaller version of himself reaching out from the River Lethe and ignored it. His shadow — the Warden Brother — told him he was failing his sister, then wrapped chains around his wrists and merged with him as a permanent reminder. He woke up from that muttering "I'm sorry" over and over, and Mira picked him up like a cat and held him until it passed.
...
Inquizo is a Rogue built around stealth, surprise, and creative improvisation. He hits precisely when he needs to and disappears when he doesn't.

**Damage & Offense**
- **Sneak Attack** — 3d6 extra damage with a finesse or ranged weapon when he has advantage or an ally is adjacent
- **Cunning Strike** — after Sneak Attack: can inflict Poison (CON save), Paralyze, or force the target to move away
...
- **Cunning Action** — bonus action Dash, Disengage, or Hide; rolled Stealth 24 during the Galveston fight
- **Stealth 28** — highest stealth roll of Session 11; critical for the palace infiltration
...
- **Voice mimic** — imitated Pmurt's voice on the airship to direct the ship to "Sypium" (Session 13); exact source of ability uncertain
...
- Deception 9 (expertise) — routinely passes as an "exotic pet" when convenient

---

### What He's Carrying

- **Stacked hats**: bard hat, tiny mystery hat (nested under the bard hat when he found it), Pmurt's crown, two tree-symbol hats with golden branches
- **The black orb** — entity inside; identity unconfirmed; NOT Caelus (Ian clarified); wrapped in spare clothes in his backpack
- **Chains of Eternity** — wrist shackles; launch to restrain a target (and himself simultaneously)
- **Skull mask** — metal, skull-face shaped, labeled "dr.l" inside; belongs to the Doctor; Inquizo won't read the label
- **Lorya's serpent-circle jewel** — purpose unknown; he took it
- **Arcus's nail image** — shows a person cutting their own stomach open
- **The spike from the blood cocoon** — dagger image frozen inside crystal
- **Plastic canary toy** — kid's meal prize from Canary Park; press the beak, the wings flap
- **Gas mask** — stolen from the back of the kidnapper caravan in Session 16
- **Hamster** — accidentally stolen alongside the gas mask
- **10 fire ant jars** (including 1 rainbow jar) — bought at the Alastair market in Session 16
- **Weird mirror** — bought at the Alastair market in Session 16; traded a piece of glass still embedded in his own body for it (*"It's still in me because I don't remember it"*)
- **Daggers ×2, Rapier, Short Sword, Light Crossbow**
- **Burglar's pack, forgery kit, dark clothes, thieves' tools**
...
**[[Halcyra]]**
She coordinated the chandelier drop with him. She covered him with her wings when the ship jumped from the pressure valve. Beyond that, Inquizo is hard to pin down in any relationship — even this one.
...
**Full Name:** Inquizo (also "Inquizion" on sheet header)
...
- **3d6** — finesse or ranged weapon with advantage, or ally adjacent to target
...
| Light Crossbow | +4 | 1d8 piercing | Range 80/320 |

### Armor & Proficiencies

- **Armor:** Leather armor
- **Weapons:** Light/Piercing, Simple, Martial (selected)
- **Tools:** Thieves' tools, Forgery kit, Thieves' cant
- **Languages:** Thieves' Cant, Goblin, Infernal, Draconic

### Class Features *(Rogue — Thief)*

- **Sneak Attack** — 3d6 extra damage
- **Cunning Action** — bonus action: Dash, Disengage, or Hide
- **Steady Aim** — bonus action: advantage on next attack (can't move this turn)
- **Cunning Strike** — after Sneak Attack: Poison (CON save), Paralyze, or Withdraw
- **Uncanny Dodge** — reaction: halve damage from one attack per round
- **Improvised Weapon Proficiency**
- **Climber** +1 to climbing | **Jump** +1 ft

### Species Traits *(Kobold)*

- **Darkvision** — 60 ft
- **Pack Tactics** variant — advantage on attacks when an ally is adjacent to the target
