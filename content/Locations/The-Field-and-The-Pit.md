...
# The Field and The Pit

> [!success] Status
> **LEFT** — The party descended underground through Lorya's secret tunnel in Session 4. The pit remains above them, full of glowing white strings that no one has explained.
...
| | |
|---|---|
| **Type** | Wilderness / supernatural barrier |
| **First Visited** | Session 3 |
| **Last Visit** | Session 4 |
| **Region** | Forest/field area; underground temple is accessible below |

---

## Description

An open field edged by a northern forest, with a circular section at its center that is wrong in a way that takes a moment to place. The pit is filled with glowing white strings — not roots, not vines, not anything with a clean name. The ground there has a mud-like resistance to movement, but only for certain people. [[Character Profiles/Mira|Mira]] walked through freely. Others needed a cloak borrowed from [[NPC Registry#Lorya|Lorya]] to pass. The northern forest is nearby, and something enormous lives there that responded to prayer.
...
- **The Pit** — Circular section filled with glowing white strings; supernatural resistance for most party members; Mira passes through freely
- **The Northern Forest** — Home of an enormous entity the party called the Good Boy of the North; also where Lorya and her hyenas retreated
- **The Underground Temple** — Accessible beneath the field via Lorya's secret tunnel (see [[Locations/The-Underground-Temple|The Underground Temple]])
